        ...
        <MuiTable aria-labelledby="tableTitle" size="small">
          <ReuseableTableHead
            ...
            headCells={[
              ...
              createHeadCell("frequency", "Frequency", false, true),
              createHeadCell("dose_time_freq", "Dose Time Freq", false, true),
              createHeadCell("meal_timing", "MealTiming", false, true),
              createHeadCell("remarks", "Remarks", false, true),
              createHeadCell("start_date", "Start Date", false, true),
              createHeadCell("end_date", "End Date", false, true),
