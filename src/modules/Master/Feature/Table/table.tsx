...
export default function Table({ rows }: TableProps) {
  ...
  // const filteredRows = applyFilter(rows, getComparator(order, orderBy));
        ...
        <MuiTable aria-labelledby="tableTitle" size="small">
          <ReuseableTableHead
            ...
            headCells={[
              ...
              createHeadCell("active", "Active", false, true),
              createHeadCell("description", "Description", false, true),
