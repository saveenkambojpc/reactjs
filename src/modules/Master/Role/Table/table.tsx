...
export default function Table({ rows }: TableProps) {
  ...
  let stableSortRows = React.useMemo(
    () =>
        ...
        <MuiTable aria-labelledby="tableTitle" size="small">
          <ReuseableTableHead
            ...
            headCells={[
              ...
              createHeadCell("scopes", "Admin", false, true),
              createHeadCell("scopes", "Editor", false, true),
              createHeadCell("scopes", "Viewer", false, true),
              createHeadCell("scopes", "Member", false, true),
              createHeadCell("scopes", "IT Admin", false, true),
              createHeadCell("scopes", "Family Admin", false, true),
              createHeadCell("scopes", "Member Admin", false, true),
              createHeadCell("scopes", "Maker", false, true),
              createHeadCell("scopes", "Checker", false, true),
              createHeadCell("name", "Updated at", false, true),
              createHeadCell("updated_by", "Updated By", false, true),
