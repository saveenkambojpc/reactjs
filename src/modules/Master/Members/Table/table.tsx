        ...
        <MuiTable aria-labelledby="tableTitle" size="small">
          <ReuseableTableHead
            ...
            headCells={[
              ...
              createHeadCell("height", "Height", false, true),
              createHeadCell("Weight", "weight", false, true),
              createHeadCell("dob", "DOB", false, true),
              createHeadCell("Member Admin", "Updated At", false, true),
